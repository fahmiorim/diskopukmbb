<div class="container content">
    <div class="d-flex flex-row row">
                            ...
                            <div class="wow fadeInUp">
                                <div class="box-shadow margin-bottom-20 ">
                                    <div class="magazine-news-img">
                                        <a href="<?= base_url() ?>/berita/detail/<?= $value['judul_seo']; ?>" rel="gallery2" class="fancybox img-hover-v1">
                                            <span><img class="img-responsive" src="<?= base_url() ?>/media/berita/<?= $value['gambar']; ?>" alt=""></span>
                                        </a>
                                    </div>
                                    <h3><a href="<?= base_url() ?>/berita/detail/<?= $value['judul_seo']; ?>"><?= $value['judul']; ?></a></h3>
                                    <div class="by-author">
        ...
        <div class="col-md-4">
            <div class="wow fadeInRight">
                <div class="tag-box tag-box-v2 box-shadow shadow-effect-1" style="background: linear-gradient( 90deg, rgba(0,77,149,255) 0%, rgba(2,103,185,255) 100%, rgba(0,77,149,255) 100% );">
                    <a href="<?= base_url() ?>/informasi/peraturan">
