    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="card-body">
                ...
                <form role="form" action="<?= base_url('admin/informasi/download_tambah'); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    ...
                    <div class="card-action">
                        ...
                        <a href="<?= base_url('admin/informasi/download') ?>" class="btn btn-danger btn-sm"> <i class="fa fa-reply"></i> Kembali</a>
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="edit<?= $value['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="card-body">
                    <!-- form start-->
                    <form role="form" action="<?= base_url('admin/informasi/download_edit/' . $value['id']); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="form-group col-sm-12">
                            <label>Nama File</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="swal-footer no-bd">
                        <a href="<?= base_url('admin/informasi/download_delete/' . $value['id']) ?>" type="button" class="btn btn-success">Gasss!!!</a></button>
                        <a href="<?= base_url('admin/informasi/download') ?>" type="button" class="btn btn-danger">Gak Jadi</a></button>
