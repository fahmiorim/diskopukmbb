                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-button-action text-center">
                                        <div class="py-3">
                                            <a href="<?= base_url('admin/galeri/foto/' . $value['id_galeri']) ?>" class="btn btn-primary">
                                                <span class="icon">
                                                    <i class="fas fa-image"></i>
                                                </span>
                                            </a>
                                        </div>
                                        <button type="button" title="Edit Data" data-toggle="modal" data-target="#edit<?= $value['id_galeri']; ?>" class="btn btn-primary btn-sm" data-original-title="Edit Task">
                                            <i class="fa fa-edit"></i>
                                        </button>
                                        <button type="button" title="Hapus" data-toggle="modal" data-target="#delete<?= $value['id_galeri']; ?>" class="btn btn-danger btn-sm" data-original-title="Remove">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="card-body">
                ...
                <form role="form" action="<?= base_url('admin/galeri/tambah'); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
