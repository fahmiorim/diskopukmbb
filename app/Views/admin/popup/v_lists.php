                    ...
                    <tbody>
                        ...
                        foreach ($popup as $key => $value) { ?>
                            <tr>
                                ...
                                <td><?= $no++; ?></td>
                                <td class=""><img src="<?= base_url('./media/popup/' . $value['gambar']) ?>" width="250px"><br>
                                <td><?= $value['judul']; ?></td>
                                <td>
...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="card-body">
                <!-- form start-->
                <form role="form" action="<?= base_url('admin/popup/tambah'); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    <div class="form-group col-sm-12">
                        <label>Judul Pop Up</label>
                    ...
                    <div class="card-action">
                        ...
                        <a href="<?= base_url('admin/popup') ?>" class="btn btn-danger btn-sm"> <i class="fa fa-reply"></i> Kembali</a>
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="edit<?= $value['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="card-body">
                    <!-- form start-->
                    <form role="form" action="<?= base_url('admin/popup/edit/' . $value['id']); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="form-group col-sm-12">
                            <label>Judul Pop Up</label>
                            <input class="form-control" type="text" name="judul" placeholder="Judul popup" value="<?= $value['judul']; ?>">
                        </div>
                        <div class="form-group col-sm-12">
                            <label>Gambar</label>
                        ...
                        <div class="form-group col-md-6">
                            <img id="blah" src=<?= base_url('./media/popup/' . $value['gambar']); ?> class="" width="280" height="150" />
                        </div>
                        <div class="card-action">
                            <button type="submit" class="btn btn-primary btn-sm"> <i class="fas fa-paper-plane"></i> Simpan</button>
                            <a href="<?= base_url('admin/popup') ?>" class="btn btn-danger btn-sm"> <i class="fa fa-reply"></i> Kembali</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="swal-footer no-bd">
                        <a href="<?= base_url('admin/popup/delete/' . $value['id']) ?>" type="button" class="btn btn-success">Gasss!!!</a></button>
                        <a href="<?= base_url('admin/popup') ?>" type="button" class="btn btn-danger">Gak Jadi</a></button>
