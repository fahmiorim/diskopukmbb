    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <!-- form start-->
                    <form role="form" action="<?= base_url('admin/' . $menu . '/edu_save'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <select class="custom-select" role="button" name="jenis" id="jenis">
                                ...
                                <option value="baca" <?php if ("baca" == old('jenis')) echo "selected" ?>>Bahan Baca</option>
                                <option value="video" <?php if ("video" == old('jenis')) echo "selected" ?>>Video</option>
                                <option value="elearning" <?php if ("elearning" == old('jenis')) echo "selected" ?>>E-learning</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-sm-10" id="file">
                            <label>File</label>
                            <input class="form-control" type="file" name="filebaca" value="<?= old('filebaca'); ?>">
                        </div>
                        ...
                        <div class="form-group col-sm-11">
                            <label>Materi</label>
                            <textarea name="materi" id="editor"><?= old('materi'); ?></textarea>
                        </div>
