    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <!-- form start-->
                    <form role="form" action="<?= base_url('admin/pelatihan/save'); ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label class="col-form-label col-sm-2">Jenis Pelatihan</label>
                            <div class="col-sm-8">
                                <select class="custom-select" role="button" name="training_category_id" value="<?= old('training_category_id'); ?>">
                                    <option disabled selected>Pilih</option>
                                    <?php foreach ($category as $key => $value) { ?>
                                        <option value="<?= $value['training_category_id'] ?>" <?php if ($value['training_category_id'] == old('training_category_id')) echo "selected" ?>><?= $value['training_name'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" name="training_title" value="<?= old('training_title'); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
