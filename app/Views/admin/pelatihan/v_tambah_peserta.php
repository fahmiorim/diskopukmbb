<div class="container">
    <form class="row" role="form" action="<?= base_url('admin/pelatihan/peserta_save/' . $pelatihan['training_id']); ?>" method="post" enctype="multipart/form-data">
        <div class="col-lg-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="form-group text-center">
                        <img id="blah" src=<?= base_url('./media/no_image.jpg'); ?> class="mx-auto rounded-circle" width="200" height="200" />
                    </div>
                    <div class="form-group text-center">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" id="business_status" role="button" name="business_status_id">
                                ...
                                <?php foreach ($business_status as $key => $value) { ?>
                                    <option value="<?= $value['business_status_name'] ?>" <?php if ($value['business_status_name'] == old('business_status_name')) echo "selected" ?>><?= $value['business_status_name'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" role="button" name="business_sector_id">
                                ...
                                <?php foreach ($business_sector as $key => $value) { ?>
                                    <option value="<?= $value['business_sector_name'] ?>" <?php if ($value['business_sector_id'] == old('business_sector_id')) echo "selected" ?>><?= $value['business_sector_id'] ?>. <?= $value['business_sector_name'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" id="business_field_umkm" role="button" name="business_field_umkm_id">
                                ...
                                <?php foreach ($business_field_umkm as $key => $value) { ?>
                                    <option value="<?= $value['business_field_umkm_name'] ?>" <?php if ($value['business_field_umkm_id'] == old('business_field_umkm_id')) echo "selected" ?>><?= $value['business_field_umkm_name'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control" name="member_koperasi" role="button">
                                <option disabled selected>Pilih</option>
                                <option value="Ya" <?php if ("Ya" == old('member_koperasi')) echo "selected" ?>>Ya</option>
                                <option value="Tidak" <?php if ("Tidak" == old('member_koperasi')) echo "selected" ?>>Tidak</option>
                            </select>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-8">
                            <select class="form-control" name="type_koperasi_id" role="button">
                                ...
                                <?php foreach ($type_koperasi as $key => $value) { ?>
                                    <option value="<?= $value['type_koperasi_name'] ?>" <?php if ($value['type_koperasi_id'] == old('type_koperasi_id')) echo "selected" ?>><?= $value['type_koperasi_name'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            <select class="form-control" name="group_koperasi_id" value="<?= old('group_koperasi_id'); ?>" role="button">
                                ...
                                <?php foreach ($group_koperasi as $key => $value) { ?>
                                    <option value="<?= $value['group_koperasi_id'] ?>. <?= $value['group_koperasi_name'] ?>" <?php if ($value['group_koperasi_id'] == old('group_koperasi_id')) echo "selected" ?>><?= $value['group_koperasi_id'] ?>. <?= $value['group_koperasi_name'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control" name="business_sector_id" value="<?= old('business_sector_id'); ?>" role="button">
                                <option disabled selected>Pilih</option>
                                <?php foreach ($business_sector as $key => $value) { ?>
                                    <option value="<?= $value['business_sector_name'] ?>" <?php if ($value['business_sector_id'] == old('koperasi_sector_id')) echo "selected" ?>><?= $value['business_sector_id'] ?>. <?= $value['business_sector_name'] ?></option>
                                <?php } ?>
                        ...
                        <div class="col-md-8">
                            <select class="form-control" name="fostered_koperasi_id" value="<?= old('fostered_koperasi_id'); ?>" role="button">
                                ...
                                <?php foreach ($fostered_koperasi as $key => $value) { ?>
                                    <option value="<?= $value['fostered_koperasi_name'] ?>" <?php if ($value['fostered_koperasi_id'] == old('fostered_koperasi_id')) echo "selected" ?>><?= $value['fostered_koperasi_name'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            <select class="form-control" name="position_koperasi_id" value="<?= old('position_koperasi_id'); ?>" role="button">
                                ...
                                <?php foreach ($position_koperasi as $key => $value) { ?>
                                    <option value="<?= $value['position_koperasi_name'] ?>" <?php if ($value['position_koperasi_id'] == old('position_koperasi_id')) echo "selected" ?>><?= $value['position_koperasi_name'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            <select class="form-control" name="form_koperasi_id" value="<?= old('form_koperasi_id'); ?>" role="button">
                                ...
                                <?php foreach ($form_koperasi as $key => $value) { ?>
                                    <option value="<?= $value['form_koperasi_name'] ?>" <?php if ($value['form_koperasi_id'] == old('form_koperasi_id')) echo "selected" ?>><?= $value['form_koperasi_name'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                            ...
                            <?php foreach ($marketing_reach_koperasi as $key => $value) { ?>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="marketing_reach_koperasi_name" value="<?= $value['marketing_reach_koperasi_id'] ?>" <?php if ($value['marketing_reach_koperasi_id'] == old('marketing_reach_koperasi_id')) echo 'checked="checked"' ?> id="koperasi_marketing">
