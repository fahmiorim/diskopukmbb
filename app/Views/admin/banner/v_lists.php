    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <div class=" float-right">
                <span class="text">Ket: hanya satu banner yang dapat di tampilkan di halaman website</span>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <form role="form" action="<?= base_url('admin/banner/tambah'); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    ...
                    <div class="card-action">
                        ...
                        <a href="<?= base_url('admin/banner') ?>" class="btn btn-danger btn-sm"> <i class="fa fa-reply"></i> Kembali</a>
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="edit<?= $value['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="card-body">
                    <!-- form start-->
                    <form role="form" action="<?= base_url('admin/banner/edit/' . $value['id']); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <!-- <div class="form-group col-sm-6">
                            <label>Posisi</label>
                            <select class="form-control" type="text" name="posisi">
                        ...
                        <div class="form-group col-md-6">
                            <img id="blah" src=<?= base_url('./media/banner/' . $value['gambar']); ?> class="" width="280" height="150" />
                        </div>
                        <div class="card-action">
                            <button type="submit" class="btn btn-primary btn-sm"> <i class="fas fa-paper-plane"></i> Simpan</button>
                            <a href="<?= base_url('admin/banner') ?>" class="btn btn-danger btn-sm"> <i class="fa fa-reply"></i> Kembali</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="swal-footer no-bd">
                        <a href="<?= base_url('admin/banner/delete/' . $value['id']) ?>" type="button" class="btn btn-success">Gasss!!!</a></button>
                        <a href="<?= base_url('admin/banner') ?>" type="button" class="btn btn-danger">Gak Jadi</a></button>
