                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-button-action text-center">
                                        <a class="btn btn-primary btn-sm" href="<?= base_url('admin/profile/edit/' . $value['id']); ?>" title="Edit"> <i class="fa fa-edit"></i></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="swal-footer no-bd">
                        <a href="<?= base_url('admin/profile/delete/' . $value['id']) ?>" type="button" class="btn btn-success">Gasss!!!</a></button>
                        <a href="<?= base_url('admin/profile/menu') ?>" type="button" class="btn btn-danger">Gak Jadi</a></button>
