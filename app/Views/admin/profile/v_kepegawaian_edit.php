            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php foreach ($pegawai as $key => $data) { ?>
                        <form role="form" action="<?= base_url('admin/profile/kepegawaian_update/' . $data['id']); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-5">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" type="text" name="golongan" required>
                                                <option selected value="<?= $data['golongan']; ?>"><?= $data['golongan']; ?></option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="number" name="urutan" value="<?= $data['urutan']; ?>">
                                        </div>
                                    </div>
