    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <!-- form start-->
                    <form role="form" action="<?= base_url('admin/video/update/' . $video['id']); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <textarea name="deskripsi" id="editor"><?= $video['deskripsi'] ?></textarea>
                        </div>
                        <br>
